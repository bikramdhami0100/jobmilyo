      ...
      <CarouselContent>
        {heroImages.map((item, index) => (
          <CarouselItem  key={index}>
            ...
            <Image alt="image" src={`${item}`} width={500} height={200} className=" m-auto w-full flex  object-right h-[200px]  md:h-[370px] lg:h-[370px] md:object-left-top lg:object-left-top "></Image>
            </div>
          </CarouselItem>
        ))}
      </CarouselContent>
