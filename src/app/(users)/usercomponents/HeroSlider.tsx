      ...
      <CarouselContent>
        {heroImages.map((item, index) => (
          <CarouselItem  key={index}>
            ...
            <Image alt="image" src={`${item}`} width={500} height={200} className=" m-auto w-full flex object-top h-[200px]  md:h-[370px] lg:h-[370px] md:object-fill lg:object-fill "></Image>
            </div>
          </CarouselItem>
        ))}
      </CarouselContent>
